...
/* @var $model app\models\WafPosition */
...
<div class="vessel-form">
    ...
    <?= $form->field($model, 'size')->dropDownList([
        WafPosition::SIZE_MR => 'Mr',
        WafPosition::SIZE_HANDY => 'Handy',
        WafPosition::SIZE_LR => 'LR'
    ], ['prompt' => '']) ?>

    <?= $form->field($model, 'grade')->dropDownList([
        WafPosition::CONDITION_CLEAN => 'Clean',
        WafPosition::CONDITION_DIRTY => 'Dirty'
    ], ['prompt' => '']) ?>
