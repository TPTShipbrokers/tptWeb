...
<div class="vessel-index">
    ...
    <p>
        <?php $form = ActiveForm::begin(['action' => Url::toRoute('ara-positions/upload'),
    ...
    <div class="form-group">
        ...
        <?= Html::a('<i class="icon-trash" data-toggle="tooltip" data-placement="top" title="Delete selected records"></i> Delete Selected', 'javascript:;', [
            ...
            'data' => [
                ...
                'url' => Url::toRoute("ara-positions/delete_selected"),
                'placement' => 'bottom'
            ]
        ]); ?>
        <?= Html::a('<i class="icon-trash" data-toggle="tooltip" data-placement="top" title="Delete all records"></i> Delete All', 'javascript:;', [
            ...
            'data' => [
                ...
                'message' => 'Records deleted',
                'errormessage' => 'An error ocurred while trying to delete records.',
                'url' => Url::toRoute("ara-positions/delete_all"),
                'placement' => 'bottom'
            ]
        ]); ?>
    </div>
    <div class="btn-group">
        ...
        <ul class="dropdown-menu pull-right">
            <li class="<?= Url::toRoute('ara-positions/index') == Url::current() ? 'active' : '' ?>">
                <a href="<?= Url::toRoute('ara-positions/index') ?>">
                    All
                </a>
            </li>
            <li class="<?= Url::toRoute('ara-positions/index/1') == Url::current() ? 'active' : '' ?>">
                <a href="<?= Url::toRoute('ara-positions/index/1') ?>">
                    Positions
                </a>
            </li>

            <li class="<?= Url::toRoute('ara-positions/index/0') == Url::current() ? 'active' : '' ?>">
                <a href="<?= Url::toRoute('ara-positions/index/0') ?>">
                    Chartering
                </a>
            </li>
                    ...
                    'delete' => function ($url, $model) {
                        return Html::a('<i class="icon-trash" data-toggle="tooltip" data-placement="top" title="Delete tanker"></i>', 'javascript:;', [
                            ...
                            'data' => [
                                ...
                                'url' => Url::toRoute("ara-positions/delete/" . $model->vessel_id),
                                'placement' => 'bottom'
                            ]
                        ]);
                    }
