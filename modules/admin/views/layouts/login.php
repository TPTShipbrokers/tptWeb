...
<head>
    ...
    <link href="<?= Yii::$app->request->baseUrl ?>/media/global/plugins/select2/css/select2.min.css" rel="stylesheet"
          type="text/css"/>
    <link href="<?= Yii::$app->request->baseUrl ?>/media/global/plugins/select2/css/select2-bootstrap.min.css"
          rel="stylesheet" type="text/css"/>
    ...
    <link href="<?= Yii::$app->request->baseUrl ?>/media/pages/css/login-4.min.css" rel="stylesheet" type="text/css"/>
...
<div class="logo">
    <a href="index.html">
        <img src="<?= Yii::$app->request->baseUrl ?>/media/pages/img/logo-big.png" alt=""/> </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
...
<!-- END LOGIN -->
<!-- BEGIN COPYRIGHT -->
<div class="copyright"> 2017 &copy; Borne Agency.</div>
<!-- END COPYRIGHT -->
<!--[if lt IE 9]>
...
<script src="<?= Yii::$app->request->baseUrl ?>/media/global/plugins/select2/js/select2.full.min.js"
        type="text/javascript"></script>
<script src="<?= Yii::$app->request->baseUrl ?>/media/global/plugins/backstretch/jquery.backstretch.min.js"
        type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
...
<script src="<?= Yii::$app->request->baseUrl ?>/media/pages/scripts/login-4.min.js" type="text/javascript"></script>
