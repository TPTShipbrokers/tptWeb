...
/**
 * VesselSearch represents the model behind the search form about `app\models\Vessel`.
 */
class VesselSearch extends Vessel
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'size', 'grade', 'built', 'status', 'open_date', 'location', 'last', 'hull', 'sire', 'tema_suitable', 'cabotage', 'nigerian_cab', 'comments', 'last_update'], 'safe'],
        ];
    }
