...
/**
 * AraPositionSearch represents the model behind the search form about `app\models\AraPosition`.
 */
class AraPositionSearch extends AraPosition
{
    /**
     * @inheritdoc
     */
